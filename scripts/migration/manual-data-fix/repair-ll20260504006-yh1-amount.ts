...
const DOCUMENT_NO = "LL20260504006";
const LINE_ID = 1710;
const MATERIAL_CODE = "yh1";
const EXPECTED_QUANTITY = "245.000000";
const EXPECTED_UNIT_COST = "8.42";
const EXPECTED_AMOUNT = "2062.90";
const WRONG_LINE_UNIT_PRICE = "14.16";
const WRONG_LINE_AMOUNT = "3469.20";
const UPDATED_BY = "manual-repair-ll20260504006-yh1-amount-20260518";
const DRY_RUN_REPORT_FILE_NAME =
  "repair-ll20260504006-yh1-amount-dry-run-report.json";
const EXECUTE_REPORT_FILE_NAME =
  "repair-ll20260504006-yh1-amount-execute-report.json";
    ...
    await withPoolConnection(pool, async (connection) => {
      ...
      const report = {
        ...
        confirmedBusinessFact:
          "业务已确认：LL20260504006 的 yh1 拉伸油（上壳下壳用）25KG/桶，单价由 14.16 改为 8.42。",
