...
const DOCUMENT_NO = "LL20260312004";
const LINE_ID = 495;
const MATERIAL_CODE = "yf2";
const MATERIAL_NAME = "拉铆钉";
const EXPECTED_QUANTITY = "2.000000";
const CONFIRMED_UNIT_COST = "140.08";
const CONFIRMED_AMOUNT = "280.16";
const WRONG_LINE_UNIT_PRICE = "90.04";
const WRONG_LINE_AMOUNT = "180.08";
const UPDATED_BY = "manual-repair-ll20260312004-yf2-document-price-20260518";
const DRY_RUN_REPORT_FILE_NAME =
  "repair-ll20260312004-yf2-document-price-dry-run-report.json";
const EXECUTE_REPORT_FILE_NAME =
  "repair-ll20260312004-yf2-document-price-execute-report.json";
    ...
    await withPoolConnection(pool, async (connection) => {
      ...
      const report = {
        ...
        confirmedBusinessFact:
          "业务已确认：LL20260312004 第 495 行 yf2 拉铆钉真实领料为 2 个 140.08 元，并非 90.04；90.04 是单据填写错误。",
