  ...
  return [
    {
      ...
      rows: [
        ...
        ["销售出库金额", params.totals.salesOutboundAmount],
        ["销售退货数量", params.totals.salesReturnQuantity],
        ["销售退货金额", params.totals.salesReturnAmount],
        ["净发生数量", params.totals.netQuantity],
        ["净发生金额", params.totals.netAmount],
        ...
        ["异常单据数", params.totals.abnormalDocumentCount],
