...
Cheap knowledge routing first: run one catalog lookup before opening broad doc trees —
`node ./scripts/knowledge/search-doc-catalog.mjs --query "<scope>" --agent planner --stage planning --limit 5` — and open only the matched docs.
