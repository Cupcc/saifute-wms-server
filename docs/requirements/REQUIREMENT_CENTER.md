...
| REQ     | 功能项 | 需求摘要                 | 来源  | 阶段      | 状态     | 关联任务 |
| ------- | --- | -------------------- | --- | ------- | ------ | ---- |
| REQ-043 | F1  | 领料 / 退料 / 报废统一单据家族 | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-044 | F2  | 主仓库存联动与来源追溯         | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-045 | F3  | 回冲关系、作废补偿与审核快照协同    | PRD | Phase 2 | 🔧 进行中 | -    |
...
| REQ     | 功能项 | 需求摘要              | 来源  | 阶段      | 状态     | 关联任务 |
| ------- | --- | ----------------- | --- | ------- | ------ | ---- |
| REQ-047 | F1  | 项目台账与独立管理页面      | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-048 | F2  | 项目物料消耗与差量库存联动    | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-049 | F3  | 项目事务家族补齐         | PRD | Phase 2 | 📋 未开始 | -    |
| REQ-050 | F4  | 项目台账余额与成本汇总      | PRD | Phase 2 | 📋 未开始 | -    |
| REQ-051 | F5  | 轻量 BOM 与项目成果归集 | PRD | Phase 3 | 📋 未开始 | -    |
...
| REQ-056 | F5  | 预警、编号区间与共享查询能力合同 | PRD | Phase 3 | 🔧 进行中 | -                    |


### 审核 — `domain/workflow-module.md`

| REQ     | 功能项 | 需求摘要            | 来源  | 阶段      | 状态     | 关联任务 |
| ------- | --- | --------------- | --- | ------- | ------ | ---- |
| REQ-057 | F1  | 审核投影创建与状态查询    | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-058 | F2  | 审核通过 / 拒绝 / 重置动作 | PRD | Phase 1 | 🔧 进行中 | -    |
| REQ-059 | F3  | 改单重置与作废前下游依赖校验 | PRD | Phase 2 | 🔧 进行中 | -    |
