...
| `F3` | 业务列表页旧风格节奏细化 | 各业务列表页恢复”查询 + 表格 + 操作”的主要节奏 | Phase 3 | `进行中` | `task-20260727-1007`（公共基线，已完成）、`task-20260727-1127`（路由表格全覆盖，已完成）、`task-20260729-1512`（偏好架构收敛与折叠持久化，已完成） |
