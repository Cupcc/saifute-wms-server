...
function mapInboundLine(line, config, order, audit = null) {
  ...
  return {
    ...
    specModel: line.materialSpecSnapshot ?? "",
    ...
    salesProjectId: order.salesProjectId ?? null,
    salesProjectCode: order.salesProjectCodeSnapshot ?? "",
    salesProjectName: order.salesProjectNameSnapshot ?? "",
