<template>
  <div class="app-container">
    ...
    <adaptive-table border stripe v-loading="loading" :data="intoDetailList" column-preferences :default-hidden-columns="['intoNo']">
      <el-table-column type="index" width="60" align="center" />
      <el-table-column sortable show-overflow-tooltip label="入库单号" align="center" prop="intoNo" key="intoNo" min-width="140"/>
      <el-table-column
        sortable
      ...
      <el-table-column sortable show-overflow-tooltip label="生产编号" align="center" prop="interval" />
      ...
      <el-table-column sortable show-overflow-tooltip label="入库数量" align="center" prop="quantity" min-width="130" class-name="numeric-column" />
