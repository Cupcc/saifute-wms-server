...
export function createSystemManagementSeedState(): SystemManagementState {
  ...
  const menus: ManagedMenuRecord[] = [
    ...
    },
    {
      ...
      menuName: "审核权限",
      orderNum: 17,
      path: "/audit-document-auth",
      component: "Layout",
      routeName: "AuditDocumentPermissions",
      menuType: "M",
      visible: "0",
      status: "0",
      perms: "",
  ...
  const users: ManagedUserRecord[] = [
    {
      ...
      extraPermissions: [
        ...
        "audit:document:reject",
        "audit:document:reset",
        "reporting:home:view",
        "reporting:inventory-summary:view",
        "reporting:material-category-summary:view",
