...
const WAREHOUSE_MANAGER_PERMISSION_PRESET = [
  ...
  "rd:procurement-demand:list",
  "rd:procurement-demand:create",
  "rd:procurement-demand:update",
  "rd:procurement-demand:delete",
...
export function createSystemManagementSeedState(): SystemManagementState {
  ...
  const menus: ManagedMenuRecord[] = [
    ...
    },
    {
      ...
      component: "reporting/monthly-reporting/index",
      routeName: "MonthlyReportingMaterialCategory",
      menuType: "C",
      visible: "0",
      status: "0",
      perms: "reporting:monthly-reporting:view",
    ...
    },
    {
      ...
      path: "/take",
      component: "Layout",
      routeName: "WorkshopMaterialBusiness",
      menuType: "M",
      visible: "0",
      status: "0",
      perms: "",
    ...
    },
    {
      ...
      visible: "0",
      status: "0",
      perms: "rd:procurement-demand:list",
      icon: "edit",
      query: "",
      isFrame: "1",
      isCache: "0",
    ...
    },
    {
      ...
      visible: "0",
      status: "0",
      perms: "rd:procurement-demand:create",
      icon: "",
      query: "",
      isFrame: "1",
      isCache: "0",
    },
    {
      ...
      visible: "0",
      status: "0",
      perms: "rd:procurement-demand:update",
      icon: "",
      query: "",
      isFrame: "1",
      isCache: "0",
    },
    {
      ...
      visible: "0",
      status: "0",
      perms: "rd:procurement-demand:delete",
      icon: "",
      query: "",
      isFrame: "1",
      isCache: "0",
    },
    {
      ...
      visible: "0",
      status: "0",
      perms: "rd:procurement-demand:manage",
      icon: "",
      query: "",
      isFrame: "1",
      isCache: "0",
    ...
    },
    {
      ...
      component: "reporting/material-category-summary/index",
      routeName: "RdMaterialCategorySummary",
      menuType: "C",
      visible: "0",
      status: "0",
      perms: "reporting:material-category-summary:view",
    ...
    },
    {
      ...
      path: "monthly-reporting-material-category",
      component: "reporting/monthly-reporting/index",
      routeName: "RdMonthlyReportingMaterialCategory",
      menuType: "C",
      visible: "0",
      status: "0",
      perms: "reporting:monthly-reporting:view",
